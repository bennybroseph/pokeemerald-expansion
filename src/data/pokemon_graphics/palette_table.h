...
const struct CompressedSpritePalette gMonFollowPaletteTable[] =
{
    //SPECIES_PAL(NONE, gMonFollowPalette_CircledQuestionMark),
    SPECIES_PAL(BULBASAUR, gMonFollowPalette_Bulbasaur),
    SPECIES_PAL(IVYSAUR, gMonFollowPalette_Ivysaur),
    SPECIES_PAL(VENUSAUR, gMonFollowPalette_Venusaur),
    SPECIES_PAL(CHARMANDER, gMonFollowPalette_Charmander),
    SPECIES_PAL(CHARMELEON, gMonFollowPalette_Charmeleon),
    SPECIES_PAL(CHARIZARD, gMonFollowPalette_Charizard),
    SPECIES_PAL(SQUIRTLE, gMonFollowPalette_Squirtle),
    SPECIES_PAL(WARTORTLE, gMonFollowPalette_Wartortle),
    SPECIES_PAL(BLASTOISE, gMonFollowPalette_Blastoise),
    SPECIES_PAL(CATERPIE, gMonFollowPalette_Caterpie),
    SPECIES_PAL(METAPOD, gMonFollowPalette_Metapod),
    SPECIES_PAL(BUTTERFREE, gMonFollowPalette_Butterfree),
    SPECIES_PAL(WEEDLE, gMonFollowPalette_Weedle),
    SPECIES_PAL(KAKUNA, gMonFollowPalette_Kakuna),
    SPECIES_PAL(BEEDRILL, gMonFollowPalette_Beedrill),
    SPECIES_PAL(PIDGEY, gMonFollowPalette_Pidgey),
    SPECIES_PAL(PIDGEOTTO, gMonFollowPalette_Pidgeotto),
    SPECIES_PAL(PIDGEOT, gMonFollowPalette_Pidgeot),
    SPECIES_PAL(RATTATA, gMonFollowPalette_Rattata),
    SPECIES_PAL(RATICATE, gMonFollowPalette_Raticate),
    SPECIES_PAL(SPEAROW, gMonFollowPalette_Spearow),
    SPECIES_PAL(FEAROW, gMonFollowPalette_Fearow),
    SPECIES_PAL(EKANS, gMonFollowPalette_Ekans),
    SPECIES_PAL(ARBOK, gMonFollowPalette_Arbok),
    SPECIES_PAL(PIKACHU, gMonFollowPalette_Pikachu),
    SPECIES_PAL(RAICHU, gMonFollowPalette_Raichu),
    SPECIES_PAL(SANDSHREW, gMonFollowPalette_Sandshrew),
    SPECIES_PAL(SANDSLASH, gMonFollowPalette_Sandslash),
    SPECIES_PAL(NIDORAN_F, gMonFollowPalette_NidoranF),
    SPECIES_PAL(NIDORINA, gMonFollowPalette_Nidorina),
    SPECIES_PAL(NIDOQUEEN, gMonFollowPalette_Nidoqueen),
    SPECIES_PAL(NIDORAN_M, gMonFollowPalette_NidoranM),
    SPECIES_PAL(NIDORINO, gMonFollowPalette_Nidorino),
    SPECIES_PAL(NIDOKING, gMonFollowPalette_Nidoking),
    SPECIES_PAL(CLEFAIRY, gMonFollowPalette_Clefairy),
    SPECIES_PAL(CLEFABLE, gMonFollowPalette_Clefable),
    SPECIES_PAL(VULPIX, gMonFollowPalette_Vulpix),
    SPECIES_PAL(NINETALES, gMonFollowPalette_Ninetales),
    SPECIES_PAL(JIGGLYPUFF, gMonFollowPalette_Jigglypuff),
    SPECIES_PAL(WIGGLYTUFF, gMonFollowPalette_Wigglytuff),
    SPECIES_PAL(ZUBAT, gMonFollowPalette_Zubat),
    SPECIES_PAL(GOLBAT, gMonFollowPalette_Golbat),
    SPECIES_PAL(ODDISH, gMonFollowPalette_Oddish),
    SPECIES_PAL(GLOOM, gMonFollowPalette_Gloom),
    SPECIES_PAL(VILEPLUME, gMonFollowPalette_Vileplume),
    SPECIES_PAL(PARAS, gMonFollowPalette_Paras),
    SPECIES_PAL(PARASECT, gMonFollowPalette_Parasect),
    SPECIES_PAL(VENONAT, gMonFollowPalette_Venonat),
    SPECIES_PAL(VENOMOTH, gMonFollowPalette_Venomoth),
    SPECIES_PAL(DIGLETT, gMonFollowPalette_Diglett),
    SPECIES_PAL(DUGTRIO, gMonFollowPalette_Dugtrio),
    SPECIES_PAL(MEOWTH, gMonFollowPalette_Meowth),
    SPECIES_PAL(PERSIAN, gMonFollowPalette_Persian),
    SPECIES_PAL(PSYDUCK, gMonFollowPalette_Psyduck),
    SPECIES_PAL(GOLDUCK, gMonFollowPalette_Golduck),
    SPECIES_PAL(MANKEY, gMonFollowPalette_Mankey),
    SPECIES_PAL(PRIMEAPE, gMonFollowPalette_Primeape),
    SPECIES_PAL(GROWLITHE, gMonFollowPalette_Growlithe),
    SPECIES_PAL(ARCANINE, gMonFollowPalette_Arcanine),
    SPECIES_PAL(POLIWAG, gMonFollowPalette_Poliwag),
    SPECIES_PAL(POLIWHIRL, gMonFollowPalette_Poliwhirl),
    SPECIES_PAL(POLIWRATH, gMonFollowPalette_Poliwrath),
    SPECIES_PAL(ABRA, gMonFollowPalette_Abra),
    SPECIES_PAL(KADABRA, gMonFollowPalette_Kadabra),
    SPECIES_PAL(ALAKAZAM, gMonFollowPalette_Alakazam),
    SPECIES_PAL(MACHOP, gMonFollowPalette_Machop),
    SPECIES_PAL(MACHOKE, gMonFollowPalette_Machoke),
    SPECIES_PAL(MACHAMP, gMonFollowPalette_Machamp),
    SPECIES_PAL(BELLSPROUT, gMonFollowPalette_Bellsprout),
    SPECIES_PAL(WEEPINBELL, gMonFollowPalette_Weepinbell),
    SPECIES_PAL(VICTREEBEL, gMonFollowPalette_Victreebel),
    SPECIES_PAL(TENTACOOL, gMonFollowPalette_Tentacool),
    SPECIES_PAL(TENTACRUEL, gMonFollowPalette_Tentacruel),
    SPECIES_PAL(GEODUDE, gMonFollowPalette_Geodude),
    SPECIES_PAL(GRAVELER, gMonFollowPalette_Graveler),
    SPECIES_PAL(GOLEM, gMonFollowPalette_Golem),
    SPECIES_PAL(PONYTA, gMonFollowPalette_Ponyta),
    SPECIES_PAL(RAPIDASH, gMonFollowPalette_Rapidash),
    SPECIES_PAL(SLOWPOKE, gMonFollowPalette_Slowpoke),
    SPECIES_PAL(SLOWBRO, gMonFollowPalette_Slowbro),
    SPECIES_PAL(MAGNEMITE, gMonFollowPalette_Magnemite),
    SPECIES_PAL(MAGNETON, gMonFollowPalette_Magneton),
    SPECIES_PAL(FARFETCHD, gMonFollowPalette_Farfetchd),
    SPECIES_PAL(DODUO, gMonFollowPalette_Doduo),
    SPECIES_PAL(DODRIO, gMonFollowPalette_Dodrio),
    SPECIES_PAL(SEEL, gMonFollowPalette_Seel),
    SPECIES_PAL(DEWGONG, gMonFollowPalette_Dewgong),
    SPECIES_PAL(GRIMER, gMonFollowPalette_Grimer),
    SPECIES_PAL(MUK, gMonFollowPalette_Muk),
    SPECIES_PAL(SHELLDER, gMonFollowPalette_Shellder),
    SPECIES_PAL(CLOYSTER, gMonFollowPalette_Cloyster),
    SPECIES_PAL(GASTLY, gMonFollowPalette_Gastly),
    SPECIES_PAL(HAUNTER, gMonFollowPalette_Haunter),
    SPECIES_PAL(GENGAR, gMonFollowPalette_Gengar),
    SPECIES_PAL(ONIX, gMonFollowPalette_Onix),
    SPECIES_PAL(DROWZEE, gMonFollowPalette_Drowzee),
    SPECIES_PAL(HYPNO, gMonFollowPalette_Hypno),
    SPECIES_PAL(KRABBY, gMonFollowPalette_Krabby),
    SPECIES_PAL(KINGLER, gMonFollowPalette_Kingler),
    SPECIES_PAL(VOLTORB, gMonFollowPalette_Voltorb),
    SPECIES_PAL(ELECTRODE, gMonFollowPalette_Electrode),
    SPECIES_PAL(EXEGGCUTE, gMonFollowPalette_Exeggcute),
    SPECIES_PAL(EXEGGUTOR, gMonFollowPalette_Exeggutor),
    SPECIES_PAL(CUBONE, gMonFollowPalette_Cubone),
    SPECIES_PAL(MAROWAK, gMonFollowPalette_Marowak),
    SPECIES_PAL(HITMONLEE, gMonFollowPalette_Hitmonlee),
    SPECIES_PAL(HITMONCHAN, gMonFollowPalette_Hitmonchan),
    SPECIES_PAL(LICKITUNG, gMonFollowPalette_Lickitung),
    SPECIES_PAL(KOFFING, gMonFollowPalette_Koffing),
    SPECIES_PAL(WEEZING, gMonFollowPalette_Weezing),
    SPECIES_PAL(RHYHORN, gMonFollowPalette_Rhyhorn),
    SPECIES_PAL(RHYDON, gMonFollowPalette_Rhydon),
    SPECIES_PAL(CHANSEY, gMonFollowPalette_Chansey),
    SPECIES_PAL(TANGELA, gMonFollowPalette_Tangela),
    SPECIES_PAL(KANGASKHAN, gMonFollowPalette_Kangaskhan),
    SPECIES_PAL(HORSEA, gMonFollowPalette_Horsea),
    SPECIES_PAL(SEADRA, gMonFollowPalette_Seadra),
    SPECIES_PAL(GOLDEEN, gMonFollowPalette_Goldeen),
    SPECIES_PAL(SEAKING, gMonFollowPalette_Seaking),
    SPECIES_PAL(STARYU, gMonFollowPalette_Staryu),
    SPECIES_PAL(STARMIE, gMonFollowPalette_Starmie),
    SPECIES_PAL(MR_MIME, gMonFollowPalette_MrMime),
    SPECIES_PAL(SCYTHER, gMonFollowPalette_Scyther),
    SPECIES_PAL(JYNX, gMonFollowPalette_Jynx),
    SPECIES_PAL(ELECTABUZZ, gMonFollowPalette_Electabuzz),
    SPECIES_PAL(MAGMAR, gMonFollowPalette_Magmar),
    SPECIES_PAL(PINSIR, gMonFollowPalette_Pinsir),
    SPECIES_PAL(TAUROS, gMonFollowPalette_Tauros),
    SPECIES_PAL(MAGIKARP, gMonFollowPalette_Magikarp),
    SPECIES_PAL(GYARADOS, gMonFollowPalette_Gyarados),
    SPECIES_PAL(LAPRAS, gMonFollowPalette_Lapras),
    SPECIES_PAL(DITTO, gMonFollowPalette_Ditto),
    SPECIES_PAL(EEVEE, gMonFollowPalette_Eevee),
    SPECIES_PAL(VAPOREON, gMonFollowPalette_Vaporeon),
    SPECIES_PAL(JOLTEON, gMonFollowPalette_Jolteon),
    SPECIES_PAL(FLAREON, gMonFollowPalette_Flareon),
    SPECIES_PAL(PORYGON, gMonFollowPalette_Porygon),
    SPECIES_PAL(OMANYTE, gMonFollowPalette_Omanyte),
    SPECIES_PAL(OMASTAR, gMonFollowPalette_Omastar),
    SPECIES_PAL(KABUTO, gMonFollowPalette_Kabuto),
    SPECIES_PAL(KABUTOPS, gMonFollowPalette_Kabutops),
    SPECIES_PAL(AERODACTYL, gMonFollowPalette_Aerodactyl),
    SPECIES_PAL(SNORLAX, gMonFollowPalette_Snorlax),
    SPECIES_PAL(ARTICUNO, gMonFollowPalette_Articuno),
    SPECIES_PAL(ZAPDOS, gMonFollowPalette_Zapdos),
    SPECIES_PAL(MOLTRES, gMonFollowPalette_Moltres),
    SPECIES_PAL(DRATINI, gMonFollowPalette_Dratini),
    SPECIES_PAL(DRAGONAIR, gMonFollowPalette_Dragonair),
    SPECIES_PAL(DRAGONITE, gMonFollowPalette_Dragonite),
    SPECIES_PAL(MEWTWO, gMonFollowPalette_Mewtwo),
    SPECIES_PAL(MEW, gMonFollowPalette_Mew),
    SPECIES_PAL(CHIKORITA, gMonFollowPalette_Chikorita),
    SPECIES_PAL(BAYLEEF, gMonFollowPalette_Bayleef),
    SPECIES_PAL(MEGANIUM, gMonFollowPalette_Meganium),
    SPECIES_PAL(CYNDAQUIL, gMonFollowPalette_Cyndaquil),
    SPECIES_PAL(QUILAVA, gMonFollowPalette_Quilava),
    SPECIES_PAL(TYPHLOSION, gMonFollowPalette_Typhlosion),
    SPECIES_PAL(TOTODILE, gMonFollowPalette_Totodile),
    SPECIES_PAL(CROCONAW, gMonFollowPalette_Croconaw),
    SPECIES_PAL(FERALIGATR, gMonFollowPalette_Feraligatr),
    SPECIES_PAL(SENTRET, gMonFollowPalette_Sentret),
    SPECIES_PAL(FURRET, gMonFollowPalette_Furret),
    SPECIES_PAL(HOOTHOOT, gMonFollowPalette_Hoothoot),
    SPECIES_PAL(NOCTOWL, gMonFollowPalette_Noctowl),
    SPECIES_PAL(LEDYBA, gMonFollowPalette_Ledyba),
    SPECIES_PAL(LEDIAN, gMonFollowPalette_Ledian),
    SPECIES_PAL(SPINARAK, gMonFollowPalette_Spinarak),
    SPECIES_PAL(ARIADOS, gMonFollowPalette_Ariados),
    SPECIES_PAL(CROBAT, gMonFollowPalette_Crobat),
    SPECIES_PAL(CHINCHOU, gMonFollowPalette_Chinchou),
    SPECIES_PAL(LANTURN, gMonFollowPalette_Lanturn),
    SPECIES_PAL(PICHU, gMonFollowPalette_Pichu),
    SPECIES_PAL(CLEFFA, gMonFollowPalette_Cleffa),
    SPECIES_PAL(IGGLYBUFF, gMonFollowPalette_Igglybuff),
    SPECIES_PAL(TOGEPI, gMonFollowPalette_Togepi),
    SPECIES_PAL(TOGETIC, gMonFollowPalette_Togetic),
    SPECIES_PAL(NATU, gMonFollowPalette_Natu),
    SPECIES_PAL(XATU, gMonFollowPalette_Xatu),
    SPECIES_PAL(MAREEP, gMonFollowPalette_Mareep),
    SPECIES_PAL(FLAAFFY, gMonFollowPalette_Flaaffy),
    SPECIES_PAL(AMPHAROS, gMonFollowPalette_Ampharos),
    SPECIES_PAL(BELLOSSOM, gMonFollowPalette_Bellossom),
    SPECIES_PAL(MARILL, gMonFollowPalette_Marill),
    SPECIES_PAL(AZUMARILL, gMonFollowPalette_Azumarill),
    SPECIES_PAL(SUDOWOODO, gMonFollowPalette_Sudowoodo),
    SPECIES_PAL(POLITOED, gMonFollowPalette_Politoed),
    SPECIES_PAL(HOPPIP, gMonFollowPalette_Hoppip),
    SPECIES_PAL(SKIPLOOM, gMonFollowPalette_Skiploom),
    SPECIES_PAL(JUMPLUFF, gMonFollowPalette_Jumpluff),
    SPECIES_PAL(AIPOM, gMonFollowPalette_Aipom),
    SPECIES_PAL(SUNKERN, gMonFollowPalette_Sunkern),
    SPECIES_PAL(SUNFLORA, gMonFollowPalette_Sunflora),
    SPECIES_PAL(YANMA, gMonFollowPalette_Yanma),
    SPECIES_PAL(WOOPER, gMonFollowPalette_Wooper),
    SPECIES_PAL(QUAGSIRE, gMonFollowPalette_Quagsire),
    SPECIES_PAL(ESPEON, gMonFollowPalette_Espeon),
    SPECIES_PAL(UMBREON, gMonFollowPalette_Umbreon),
    SPECIES_PAL(MURKROW, gMonFollowPalette_Murkrow),
    SPECIES_PAL(SLOWKING, gMonFollowPalette_Slowking),
    SPECIES_PAL(MISDREAVUS, gMonFollowPalette_Misdreavus),
    SPECIES_PAL(UNOWN, gMonFollowPalette_Unown),
    SPECIES_PAL(WOBBUFFET, gMonFollowPalette_Wobbuffet),
    SPECIES_PAL(GIRAFARIG, gMonFollowPalette_Girafarig),
    SPECIES_PAL(PINECO, gMonFollowPalette_Pineco),
    SPECIES_PAL(FORRETRESS, gMonFollowPalette_Forretress),
    SPECIES_PAL(DUNSPARCE, gMonFollowPalette_Dunsparce),
    SPECIES_PAL(GLIGAR, gMonFollowPalette_Gligar),
    SPECIES_PAL(STEELIX, gMonFollowPalette_Steelix),
    SPECIES_PAL(SNUBBULL, gMonFollowPalette_Snubbull),
    SPECIES_PAL(GRANBULL, gMonFollowPalette_Granbull),
    SPECIES_PAL(QWILFISH, gMonFollowPalette_Qwilfish),
    SPECIES_PAL(SCIZOR, gMonFollowPalette_Scizor),
    SPECIES_PAL(SHUCKLE, gMonFollowPalette_Shuckle),
    SPECIES_PAL(HERACROSS, gMonFollowPalette_Heracross),
    SPECIES_PAL(SNEASEL, gMonFollowPalette_Sneasel),
    SPECIES_PAL(TEDDIURSA, gMonFollowPalette_Teddiursa),
    SPECIES_PAL(URSARING, gMonFollowPalette_Ursaring),
    SPECIES_PAL(SLUGMA, gMonFollowPalette_Slugma),
    SPECIES_PAL(MAGCARGO, gMonFollowPalette_Magcargo),
    SPECIES_PAL(SWINUB, gMonFollowPalette_Swinub),
    SPECIES_PAL(PILOSWINE, gMonFollowPalette_Piloswine),
    SPECIES_PAL(CORSOLA, gMonFollowPalette_Corsola),
    SPECIES_PAL(REMORAID, gMonFollowPalette_Remoraid),
    SPECIES_PAL(OCTILLERY, gMonFollowPalette_Octillery),
    SPECIES_PAL(DELIBIRD, gMonFollowPalette_Delibird),
    SPECIES_PAL(MANTINE, gMonFollowPalette_Mantine),
    SPECIES_PAL(SKARMORY, gMonFollowPalette_Skarmory),
    SPECIES_PAL(HOUNDOUR, gMonFollowPalette_Houndour),
    SPECIES_PAL(HOUNDOOM, gMonFollowPalette_Houndoom),
    SPECIES_PAL(KINGDRA, gMonFollowPalette_Kingdra),
    SPECIES_PAL(PHANPY, gMonFollowPalette_Phanpy),
    SPECIES_PAL(DONPHAN, gMonFollowPalette_Donphan),
    SPECIES_PAL(PORYGON2, gMonFollowPalette_Porygon2),
    SPECIES_PAL(STANTLER, gMonFollowPalette_Stantler),
    SPECIES_PAL(SMEARGLE, gMonFollowPalette_Smeargle),
    SPECIES_PAL(TYROGUE, gMonFollowPalette_Tyrogue),
    SPECIES_PAL(HITMONTOP, gMonFollowPalette_Hitmontop),
    SPECIES_PAL(SMOOCHUM, gMonFollowPalette_Smoochum),
    SPECIES_PAL(ELEKID, gMonFollowPalette_Elekid),
    SPECIES_PAL(MAGBY, gMonFollowPalette_Magby),
    SPECIES_PAL(MILTANK, gMonFollowPalette_Miltank),
    SPECIES_PAL(BLISSEY, gMonFollowPalette_Blissey),
    SPECIES_PAL(RAIKOU, gMonFollowPalette_Raikou),
    SPECIES_PAL(ENTEI, gMonFollowPalette_Entei),
    SPECIES_PAL(SUICUNE, gMonFollowPalette_Suicune),
    SPECIES_PAL(LARVITAR, gMonFollowPalette_Larvitar),
    SPECIES_PAL(PUPITAR, gMonFollowPalette_Pupitar),
    SPECIES_PAL(TYRANITAR, gMonFollowPalette_Tyranitar),
    SPECIES_PAL(LUGIA, gMonFollowPalette_Lugia),
    SPECIES_PAL(HO_OH, gMonFollowPalette_HoOh),
    SPECIES_PAL(CELEBI, gMonFollowPalette_Celebi),
    SPECIES_PAL(TREECKO, gMonFollowPalette_Treecko),
    SPECIES_PAL(GROVYLE, gMonFollowPalette_Grovyle),
    SPECIES_PAL(SCEPTILE, gMonFollowPalette_Sceptile),
    SPECIES_PAL(TORCHIC, gMonFollowPalette_Torchic),
    SPECIES_PAL(COMBUSKEN, gMonFollowPalette_Combusken),
    SPECIES_PAL(BLAZIKEN, gMonFollowPalette_Blaziken),
    SPECIES_PAL(MUDKIP, gMonFollowPalette_Mudkip),
    SPECIES_PAL(MARSHTOMP, gMonFollowPalette_Marshtomp),
    SPECIES_PAL(SWAMPERT, gMonFollowPalette_Swampert),
    SPECIES_PAL(POOCHYENA, gMonFollowPalette_Poochyena),
    SPECIES_PAL(MIGHTYENA, gMonFollowPalette_Mightyena),
    SPECIES_PAL(ZIGZAGOON, gMonFollowPalette_Zigzagoon),
    SPECIES_PAL(LINOONE, gMonFollowPalette_Linoone),
    SPECIES_PAL(WURMPLE, gMonFollowPalette_Wurmple),
    SPECIES_PAL(SILCOON, gMonFollowPalette_Silcoon),
    SPECIES_PAL(BEAUTIFLY, gMonFollowPalette_Beautifly),
    SPECIES_PAL(CASCOON, gMonFollowPalette_Cascoon),
    SPECIES_PAL(DUSTOX, gMonFollowPalette_Dustox),
    SPECIES_PAL(LOTAD, gMonFollowPalette_Lotad),
    SPECIES_PAL(LOMBRE, gMonFollowPalette_Lombre),
    SPECIES_PAL(LUDICOLO, gMonFollowPalette_Ludicolo),
    SPECIES_PAL(SEEDOT, gMonFollowPalette_Seedot),
    SPECIES_PAL(NUZLEAF, gMonFollowPalette_Nuzleaf),
    SPECIES_PAL(SHIFTRY, gMonFollowPalette_Shiftry),
    SPECIES_PAL(NINCADA, gMonFollowPalette_Nincada),
    SPECIES_PAL(NINJASK, gMonFollowPalette_Ninjask),
    SPECIES_PAL(SHEDINJA, gMonFollowPalette_Shedinja),
    SPECIES_PAL(TAILLOW, gMonFollowPalette_Taillow),
    SPECIES_PAL(SWELLOW, gMonFollowPalette_Swellow),
    SPECIES_PAL(SHROOMISH, gMonFollowPalette_Shroomish),
    SPECIES_PAL(BRELOOM, gMonFollowPalette_Breloom),
    SPECIES_PAL(SPINDA, gMonFollowPalette_Spinda),
    SPECIES_PAL(WINGULL, gMonFollowPalette_Wingull),
    SPECIES_PAL(PELIPPER, gMonFollowPalette_Pelipper),
    SPECIES_PAL(SURSKIT, gMonFollowPalette_Surskit),
    SPECIES_PAL(MASQUERAIN, gMonFollowPalette_Masquerain),
    SPECIES_PAL(WAILMER, gMonFollowPalette_Wailmer),
    SPECIES_PAL(WAILORD, gMonFollowPalette_Wailord),
    SPECIES_PAL(SKITTY, gMonFollowPalette_Skitty),
    SPECIES_PAL(DELCATTY, gMonFollowPalette_Delcatty),
    SPECIES_PAL(KECLEON, gMonFollowPalette_Kecleon),
    SPECIES_PAL(BALTOY, gMonFollowPalette_Baltoy),
    SPECIES_PAL(CLAYDOL, gMonFollowPalette_Claydol),
    SPECIES_PAL(NOSEPASS, gMonFollowPalette_Nosepass),
    SPECIES_PAL(TORKOAL, gMonFollowPalette_Torkoal),
    SPECIES_PAL(SABLEYE, gMonFollowPalette_Sableye),
    SPECIES_PAL(BARBOACH, gMonFollowPalette_Barboach),
    SPECIES_PAL(WHISCASH, gMonFollowPalette_Whiscash),
    SPECIES_PAL(LUVDISC, gMonFollowPalette_Luvdisc),
    SPECIES_PAL(CORPHISH, gMonFollowPalette_Corphish),
    SPECIES_PAL(CRAWDAUNT, gMonFollowPalette_Crawdaunt),
    SPECIES_PAL(FEEBAS, gMonFollowPalette_Feebas),
    SPECIES_PAL(MILOTIC, gMonFollowPalette_Milotic),
    SPECIES_PAL(CARVANHA, gMonFollowPalette_Carvanha),
    SPECIES_PAL(SHARPEDO, gMonFollowPalette_Sharpedo),
    SPECIES_PAL(TRAPINCH, gMonFollowPalette_Trapinch),
    SPECIES_PAL(VIBRAVA, gMonFollowPalette_Vibrava),
    SPECIES_PAL(FLYGON, gMonFollowPalette_Flygon),
    SPECIES_PAL(MAKUHITA, gMonFollowPalette_Makuhita),
    SPECIES_PAL(HARIYAMA, gMonFollowPalette_Hariyama),
    SPECIES_PAL(ELECTRIKE, gMonFollowPalette_Electrike),
    SPECIES_PAL(MANECTRIC, gMonFollowPalette_Manectric),
    SPECIES_PAL(NUMEL, gMonFollowPalette_Numel),
    SPECIES_PAL(CAMERUPT, gMonFollowPalette_Camerupt),
    SPECIES_PAL(SPHEAL, gMonFollowPalette_Spheal),
    SPECIES_PAL(SEALEO, gMonFollowPalette_Sealeo),
    SPECIES_PAL(WALREIN, gMonFollowPalette_Walrein),
    SPECIES_PAL(CACNEA, gMonFollowPalette_Cacnea),
    SPECIES_PAL(CACTURNE, gMonFollowPalette_Cacturne),
    SPECIES_PAL(SNORUNT, gMonFollowPalette_Snorunt),
    SPECIES_PAL(GLALIE, gMonFollowPalette_Glalie),
    SPECIES_PAL(LUNATONE, gMonFollowPalette_Lunatone),
    SPECIES_PAL(SOLROCK, gMonFollowPalette_Solrock),
    SPECIES_PAL(AZURILL, gMonFollowPalette_Azurill),
    SPECIES_PAL(SPOINK, gMonFollowPalette_Spoink),
    SPECIES_PAL(GRUMPIG, gMonFollowPalette_Grumpig),
    SPECIES_PAL(PLUSLE, gMonFollowPalette_Plusle),
    SPECIES_PAL(MINUN, gMonFollowPalette_Minun),
    SPECIES_PAL(MAWILE, gMonFollowPalette_Mawile),
    SPECIES_PAL(MEDITITE, gMonFollowPalette_Meditite),
    SPECIES_PAL(MEDICHAM, gMonFollowPalette_Medicham),
    SPECIES_PAL(SWABLU, gMonFollowPalette_Swablu),
    SPECIES_PAL(ALTARIA, gMonFollowPalette_Altaria),
    SPECIES_PAL(WYNAUT, gMonFollowPalette_Wynaut),
    SPECIES_PAL(DUSKULL, gMonFollowPalette_Duskull),
    SPECIES_PAL(DUSCLOPS, gMonFollowPalette_Dusclops),
    SPECIES_PAL(ROSELIA, gMonFollowPalette_Roselia),
    SPECIES_PAL(SLAKOTH, gMonFollowPalette_Slakoth),
    SPECIES_PAL(VIGOROTH, gMonFollowPalette_Vigoroth),
    SPECIES_PAL(SLAKING, gMonFollowPalette_Slaking),
    SPECIES_PAL(GULPIN, gMonFollowPalette_Gulpin),
    SPECIES_PAL(SWALOT, gMonFollowPalette_Swalot),
    SPECIES_PAL(TROPIUS, gMonFollowPalette_Tropius),
    SPECIES_PAL(WHISMUR, gMonFollowPalette_Whismur),
    SPECIES_PAL(LOUDRED, gMonFollowPalette_Loudred),
    SPECIES_PAL(EXPLOUD, gMonFollowPalette_Exploud),
    SPECIES_PAL(CLAMPERL, gMonFollowPalette_Clamperl),
    SPECIES_PAL(HUNTAIL, gMonFollowPalette_Huntail),
    SPECIES_PAL(GOREBYSS, gMonFollowPalette_Gorebyss),
    SPECIES_PAL(ABSOL, gMonFollowPalette_Absol),
    SPECIES_PAL(SHUPPET, gMonFollowPalette_Shuppet),
    SPECIES_PAL(BANETTE, gMonFollowPalette_Banette),
    SPECIES_PAL(SEVIPER, gMonFollowPalette_Seviper),
    SPECIES_PAL(ZANGOOSE, gMonFollowPalette_Zangoose),
    SPECIES_PAL(RELICANTH, gMonFollowPalette_Relicanth),
    SPECIES_PAL(ARON, gMonFollowPalette_Aron),
    SPECIES_PAL(LAIRON, gMonFollowPalette_Lairon),
    SPECIES_PAL(AGGRON, gMonFollowPalette_Aggron),
    SPECIES_PAL(CASTFORM, gMonFollowPalette_Castform),
    SPECIES_PAL(VOLBEAT, gMonFollowPalette_Volbeat),
    SPECIES_PAL(ILLUMISE, gMonFollowPalette_Illumise),
    SPECIES_PAL(LILEEP, gMonFollowPalette_Lileep),
    SPECIES_PAL(CRADILY, gMonFollowPalette_Cradily),
    SPECIES_PAL(ANORITH, gMonFollowPalette_Anorith),
    SPECIES_PAL(ARMALDO, gMonFollowPalette_Armaldo),
    SPECIES_PAL(RALTS, gMonFollowPalette_Ralts),
    SPECIES_PAL(KIRLIA, gMonFollowPalette_Kirlia),
    SPECIES_PAL(GARDEVOIR, gMonFollowPalette_Gardevoir),
    SPECIES_PAL(BAGON, gMonFollowPalette_Bagon),
    SPECIES_PAL(SHELGON, gMonFollowPalette_Shelgon),
    SPECIES_PAL(SALAMENCE, gMonFollowPalette_Salamence),
    SPECIES_PAL(BELDUM, gMonFollowPalette_Beldum),
    SPECIES_PAL(METANG, gMonFollowPalette_Metang),
    SPECIES_PAL(METAGROSS, gMonFollowPalette_Metagross),
    SPECIES_PAL(REGIROCK, gMonFollowPalette_Regirock),
    SPECIES_PAL(REGICE, gMonFollowPalette_Regice),
    SPECIES_PAL(REGISTEEL, gMonFollowPalette_Registeel),
    SPECIES_PAL(KYOGRE, gMonFollowPalette_Kyogre),
    SPECIES_PAL(GROUDON, gMonFollowPalette_Groudon),
    SPECIES_PAL(RAYQUAZA, gMonFollowPalette_Rayquaza),
    SPECIES_PAL(LATIAS, gMonFollowPalette_Latias),
    SPECIES_PAL(LATIOS, gMonFollowPalette_Latios),
    SPECIES_PAL(JIRACHI, gMonFollowPalette_Jirachi),
    SPECIES_PAL(DEOXYS, gMonFollowPalette_Deoxys),
    SPECIES_PAL(CHIMECHO, gMonFollowPalette_Chimecho),

#if P_GEN_4_POKEMON == TRUE
    SPECIES_PAL(TURTWIG, gMonFollowPalette_Turtwig),
    SPECIES_PAL(GROTLE, gMonFollowPalette_Grotle),
    SPECIES_PAL(TORTERRA, gMonFollowPalette_Torterra),
    SPECIES_PAL(CHIMCHAR, gMonFollowPalette_Chimchar),
    SPECIES_PAL(MONFERNO, gMonFollowPalette_Monferno),
    SPECIES_PAL(INFERNAPE, gMonFollowPalette_Infernape),
    SPECIES_PAL(PIPLUP, gMonFollowPalette_Piplup),
    SPECIES_PAL(PRINPLUP, gMonFollowPalette_Prinplup),
    SPECIES_PAL(EMPOLEON, gMonFollowPalette_Empoleon),
    SPECIES_PAL(STARLY, gMonFollowPalette_Starly),
    SPECIES_PAL(STARAVIA, gMonFollowPalette_Staravia),
    SPECIES_PAL(STARAPTOR, gMonFollowPalette_Staraptor),
    SPECIES_PAL(BIDOOF, gMonFollowPalette_Bidoof),
    SPECIES_PAL(BIBAREL, gMonFollowPalette_Bibarel),
    SPECIES_PAL(KRICKETOT, gMonFollowPalette_Kricketot),
    SPECIES_PAL(KRICKETUNE, gMonFollowPalette_Kricketune),
    SPECIES_PAL(SHINX, gMonFollowPalette_Shinx),
    SPECIES_PAL(LUXIO, gMonFollowPalette_Luxio),
    SPECIES_PAL(LUXRAY, gMonFollowPalette_Luxray),
    SPECIES_PAL(BUDEW, gMonFollowPalette_Budew),
    SPECIES_PAL(ROSERADE, gMonFollowPalette_Roserade),
    SPECIES_PAL(CRANIDOS, gMonFollowPalette_Cranidos),
    SPECIES_PAL(RAMPARDOS, gMonFollowPalette_Rampardos),
    SPECIES_PAL(SHIELDON, gMonFollowPalette_Shieldon),
    SPECIES_PAL(BASTIODON, gMonFollowPalette_Bastiodon),
    SPECIES_PAL(BURMY, gMonFollowPalette_Burmy),
    SPECIES_PAL(WORMADAM, gMonFollowPalette_Wormadam),
    SPECIES_PAL(MOTHIM, gMonFollowPalette_Mothim),
    SPECIES_PAL(COMBEE, gMonFollowPalette_Combee),
    SPECIES_PAL(VESPIQUEN, gMonFollowPalette_Vespiquen),
    SPECIES_PAL(PACHIRISU, gMonFollowPalette_Pachirisu),
    SPECIES_PAL(BUIZEL, gMonFollowPalette_Buizel),
    SPECIES_PAL(FLOATZEL, gMonFollowPalette_Floatzel),
    SPECIES_PAL(CHERUBI, gMonFollowPalette_Cherubi),
    SPECIES_PAL(CHERRIM, gMonFollowPalette_Cherrim),
    SPECIES_PAL(SHELLOS, gMonFollowPalette_Shellos),
    SPECIES_PAL(GASTRODON, gMonFollowPalette_Gastrodon),
    SPECIES_PAL(AMBIPOM, gMonFollowPalette_Ambipom),
    SPECIES_PAL(DRIFLOON, gMonFollowPalette_Drifloon),
    SPECIES_PAL(DRIFBLIM, gMonFollowPalette_Drifblim),
    SPECIES_PAL(BUNEARY, gMonFollowPalette_Buneary),
    SPECIES_PAL(LOPUNNY, gMonFollowPalette_Lopunny),
    SPECIES_PAL(MISMAGIUS, gMonFollowPalette_Mismagius),
    SPECIES_PAL(HONCHKROW, gMonFollowPalette_Honchkrow),
    SPECIES_PAL(GLAMEOW, gMonFollowPalette_Glameow),
    SPECIES_PAL(PURUGLY, gMonFollowPalette_Purugly),
    SPECIES_PAL(CHINGLING, gMonFollowPalette_Chingling),
    SPECIES_PAL(STUNKY, gMonFollowPalette_Stunky),
    SPECIES_PAL(SKUNTANK, gMonFollowPalette_Skuntank),
    SPECIES_PAL(BRONZOR, gMonFollowPalette_Bronzor),
    SPECIES_PAL(BRONZONG, gMonFollowPalette_Bronzong),
    SPECIES_PAL(BONSLY, gMonFollowPalette_Bonsly),
    SPECIES_PAL(MIME_JR, gMonFollowPalette_MimeJr),
    SPECIES_PAL(HAPPINY, gMonFollowPalette_Happiny),
    SPECIES_PAL(CHATOT, gMonFollowPalette_Chatot),
    SPECIES_PAL(SPIRITOMB, gMonFollowPalette_Spiritomb),
    SPECIES_PAL(GIBLE, gMonFollowPalette_Gible),
    SPECIES_PAL(GABITE, gMonFollowPalette_Gabite),
    SPECIES_PAL(GARCHOMP, gMonFollowPalette_Garchomp),
    SPECIES_PAL(MUNCHLAX, gMonFollowPalette_Munchlax),
    SPECIES_PAL(RIOLU, gMonFollowPalette_Riolu),
    SPECIES_PAL(LUCARIO, gMonFollowPalette_Lucario),
    SPECIES_PAL(HIPPOPOTAS, gMonFollowPalette_Hippopotas),
    SPECIES_PAL(HIPPOWDON, gMonFollowPalette_Hippowdon),
    SPECIES_PAL(SKORUPI, gMonFollowPalette_Skorupi),
    SPECIES_PAL(DRAPION, gMonFollowPalette_Drapion),
    SPECIES_PAL(CROAGUNK, gMonFollowPalette_Croagunk),
    SPECIES_PAL(TOXICROAK, gMonFollowPalette_Toxicroak),
    SPECIES_PAL(CARNIVINE, gMonFollowPalette_Carnivine),
    SPECIES_PAL(FINNEON, gMonFollowPalette_Finneon),
    SPECIES_PAL(LUMINEON, gMonFollowPalette_Lumineon),
    SPECIES_PAL(MANTYKE, gMonFollowPalette_Mantyke),
    SPECIES_PAL(SNOVER, gMonFollowPalette_Snover),
    SPECIES_PAL(ABOMASNOW, gMonFollowPalette_Abomasnow),
    SPECIES_PAL(WEAVILE, gMonFollowPalette_Weavile),
    SPECIES_PAL(MAGNEZONE, gMonFollowPalette_Magnezone),
    SPECIES_PAL(LICKILICKY, gMonFollowPalette_Lickilicky),
    SPECIES_PAL(RHYPERIOR, gMonFollowPalette_Rhyperior),
    SPECIES_PAL(TANGROWTH, gMonFollowPalette_Tangrowth),
    SPECIES_PAL(ELECTIVIRE, gMonFollowPalette_Electivire),
    SPECIES_PAL(MAGMORTAR, gMonFollowPalette_Magmortar),
    SPECIES_PAL(TOGEKISS, gMonFollowPalette_Togekiss),
    SPECIES_PAL(YANMEGA, gMonFollowPalette_Yanmega),
    SPECIES_PAL(LEAFEON, gMonFollowPalette_Leafeon),
    SPECIES_PAL(GLACEON, gMonFollowPalette_Glaceon),
    SPECIES_PAL(GLISCOR, gMonFollowPalette_Gliscor),
    SPECIES_PAL(MAMOSWINE, gMonFollowPalette_Mamoswine),
    SPECIES_PAL(PORYGON_Z, gMonFollowPalette_PorygonZ),
    SPECIES_PAL(GALLADE, gMonFollowPalette_Gallade),
    SPECIES_PAL(PROBOPASS, gMonFollowPalette_Probopass),
    SPECIES_PAL(DUSKNOIR, gMonFollowPalette_Dusknoir),
    SPECIES_PAL(FROSLASS, gMonFollowPalette_Froslass),
    SPECIES_PAL(ROTOM, gMonFollowPalette_Rotom),
    SPECIES_PAL(UXIE, gMonFollowPalette_Uxie),
    SPECIES_PAL(MESPRIT, gMonFollowPalette_Mesprit),
    SPECIES_PAL(AZELF, gMonFollowPalette_Azelf),
    SPECIES_PAL(DIALGA, gMonFollowPalette_Dialga),
    SPECIES_PAL(PALKIA, gMonFollowPalette_Palkia),
    SPECIES_PAL(HEATRAN, gMonFollowPalette_Heatran),
    SPECIES_PAL(REGIGIGAS, gMonFollowPalette_Regigigas),
    SPECIES_PAL(GIRATINA, gMonFollowPalette_Giratina),
    SPECIES_PAL(CRESSELIA, gMonFollowPalette_Cresselia),
    SPECIES_PAL(PHIONE, gMonFollowPalette_Phione),
    SPECIES_PAL(MANAPHY, gMonFollowPalette_Manaphy),
    SPECIES_PAL(DARKRAI, gMonFollowPalette_Darkrai),
    SPECIES_PAL(SHAYMIN, gMonFollowPalette_Shaymin),
    SPECIES_PAL(ARCEUS, gMonFollowPalette_Arceus),
#endif
};