...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_100] = {MAP_GROUP(ROUTE100), MAP_NUM(ROUTE100), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_PETALBURG_WOODS_EAST] = {MAP_GROUP(PETALBURG_WOODS_EAST), MAP_NUM(PETALBURG_WOODS_EAST), HEAL_LOCATION_PETALBURG_WOODS_EAST},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_PETALBURG_WOODS_EAST:
        return FlagGet(FLAG_VISITED_PETALBURG_WOODS_EAST) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
